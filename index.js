    ...
    while (token_number < _this.tokens.length) {
      ...
      if (token.type == "Color" && isParagraph == true) {
        var _el21 = {
          ...
          value: token.value,
          name: token.name,
          row: token.value + "." + token.name
        };

        _this.ast.children[_this.ast.children.length - 1].children.push(_el21);

        _this.ast.children[_this.ast.children.length - 1].row = _this.ast.children[_this.ast.children.length - 1].row + token.value + "." + token.name;
      }
      ...
      if (token.type == "InlineCode" && isParagraph == true) {
        ...
        _this.ast.children[_this.ast.children.length - 1].children.push(_el25);
      ...
      if (token.type == "UnderDash" && isParagraph == true) {
        ...
        _this.ast.children[_this.ast.children.length - 1].children.push(_el27);
        ...
        text.forEach(function (stroke) {
          if (stroke != '' && stroke != ' ') {
            ...
            if (stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.COLOR) != null) {
              ...
              itokens.push({
                type: _Types__WEBPACK_IMPORTED_MODULE_1__.TokensType.COLOR,
                value: stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.COLOR)[1],
                name: stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.COLOR)[3]
              });
              itokens.push({
                type: _Types__WEBPACK_IMPORTED_MODULE_1__.TokensType.TEXT,
                value: _arr3[1]
            ...
            if (stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.BADGE) != null) {
              ...
              itokens.push({
                type: _Types__WEBPACK_IMPORTED_MODULE_1__.TokensType.BADGE,
                value: stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.BADGE)[1],
                name: stroke.match(_Grammar__WEBPACK_IMPORTED_MODULE_0__.Grammar.BLOCKS.BADGE)[3]
              });
              itokens.push({
                type: _Types__WEBPACK_IMPORTED_MODULE_1__.TokensType.TEXT,
                value: _arr4[1]
