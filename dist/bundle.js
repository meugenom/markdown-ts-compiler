...
/***/ "./content/posts/instruction-to-write-text.md":
/*!****************************************************!*\
  !*** ./content/posts/instruction-to-write-text.md ***!
  \****************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _parser_View_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parser/View.js */ \"./src/scripts/parser/View.js\");\n/* harmony import */ var _parser_Language_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parser/Language.js */ \"./src/scripts/parser/Language.js\");\n/* harmony import */ var _content_posts_instruction_to_write_text_md__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../content/posts/instruction-to-write-text.md */ \"./content/posts/instruction-to-write-text.md\");\n/* harmony import */ var prismjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prismjs */ \"./node_modules/prismjs/prism.js\");\n/* harmony import */ var prismjs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prismjs__WEBPACK_IMPORTED_MODULE_3__);\n\n\n\n //import markable text to parse \n\n // Import PrismJS package\n\n\nvar markableToHtml = new _parser_View_js__WEBPACK_IMPORTED_MODULE_0__[\"View\"](_content_posts_instruction_to_write_text_md__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\nmarkableToHtml.render(); // Highlight all matching syntax\n\nprismjs__WEBPACK_IMPORTED_MODULE_3___default.a.highlightAll(); //set languages\n\n_parser_Language_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].setLanguage();\n\n//# sourceURL=webpack:///./src/scripts/index.js?");

/***/ }),

/***/ "./src/scripts/parser/Config.js":
/*!**************************************!*\
  !*** ./src/scripts/parser/Config.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config.js */ \"./src/scripts/parser/Config.js\");\n\n\n\nvar Language = {\n  replaceLanguage: function replaceLanguage(node, language) {\n    var string = node.innerHTML;\n    string = string.replace(language, \"\");\n    node.innerHTML = string;\n\n    if (language != \"\") {\n      node.dataset.language = language;\n    } else {\n      node.dataset.language = \"@all\";\n    }\n\n    return node;\n  },\n  detectLanguage: function detectLanguage(node) {\n    //by default is english\n    var language = \"\";\n    var string = node.outerHTML;\n    var en = string.lastIndexOf(_Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].english);\n    var de = string.lastIndexOf(_Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].german);\n    var ru = string.lastIndexOf(_Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].russian);\n    var all = string.lastIndexOf(_Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].multi);\n    if (en >= 0) language = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].english;\n    if (de >= 0) language = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].german;\n    if (ru >= 0) language = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].russian;\n    if (all >= 0) language = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].multi;\n    return language;\n  },\n  parseLang: function parseLang(node) {\n    var language = Language.detectLanguage(node);\n    node = Language.replaceLanguage(node, language);\n    return node;\n  },\n  setLanguage: function setLanguage() {\n    //by default we can see english version\n    var language = \"@en\"; //add event listeners to languages buttons\n\n    var english = document.getElementById(\"englishSelector\");\n    var german = document.getElementById(\"germanSelector\");\n    var russian = document.getElementById(\"russianSelector\");\n    english.addEventListener(\"click\", function () {\n      language = \"@en\"; //console.log('Language changed on English')\n\n      changeLanguage();\n    });\n    german.addEventListener(\"click\", function () {\n      language = \"@de\"; //console.log('Language changed on German')\n\n      changeLanguage();\n    });\n    russian.addEventListener(\"click\", function () {\n      language = \"@ru\"; //console.log('Language changed on Russian')\n\n      changeLanguage();\n    });\n\n    function changeLanguage() {\n      /** by default multi*/\n      var article = document.querySelector(\"article\");\n      var articles = article.childNodes;\n      articles.forEach(function (node) {\n        if (node.dataset != undefined) {\n          if (node.dataset.language == language || node.dataset.language == \"@all\") {\n            node.style.display = \"\";\n          } else {\n            if (node.tagName != \"HEADER\") {\n              node.style.display = \"none\";\n            }\n          }\n        }\n      });\n    } //first loading\n\n\n    language = \"@en\";\n    changeLanguage();\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (Language);\n\n//# sourceURL=webpack:///./src/scripts/parser/Language.js?");

/***/ }),

/***/ "./src/scripts/parser/Line.js":
/*!************************************!*\
  !*** ./src/scripts/parser/Line.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Line\", function() { return Line; });\n/* harmony import */ var _Config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config.js */ \"./src/scripts/parser/Config.js\");\n/* harmony import */ var _Word_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Word.js */ \"./src/scripts/parser/Word.js\");\n\n\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _get(target, property, receiver) { if (typeof Reflect !== \"undefined\" && Reflect.get) { _get = Reflect.get; } else { _get = function _get(target, property, receiver) { var base = _superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return _get(target, property, receiver || target); }\n\nfunction _superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf(object); if (object === null) break; } return object; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\n\n\nvar Line =\n/*#__PURE__*/\nfunction (_Word) {\n  _inherits(Line, _Word);\n\n  function Line() {\n    var _this;\n\n    _classCallCheck(this, Line);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(Line).call(this));\n    _this.Config = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    _this.output = \"\";\n    _this.arrayOfStrings = [];\n    _this.codeBlockTrigger = _get(_getPrototypeOf(Line.prototype), \"codeBlockTrigger\", _assertThisInitialized(_this));\n    _this.infoAboutPostTrigger = _get(_getPrototypeOf(Line.prototype), \"infoAboutPostTrigger\", _assertThisInitialized(_this));\n    return _this;\n  }\n\n  _createClass(Line, [{\n    key: \"parse\",\n    value: function parse(line) {\n      var arrayOfWords = line.split(this.Config.separator.newSpace);\n\n      if (this.codeBlockTrigger) {\n        return this.setCodeBlock(line);\n      } else if (this.infoAboutPostTrigger) {\n        return this.setInfoAboutPost(line);\n      } else {\n        return arrayOfWords[0] === \"#####\" ? this.setHeadLine(line.slice(5), \"h5\") : arrayOfWords[0] === \"####\" ? this.setHeadLine(line.slice(4), \"h4\") : arrayOfWords[0] === \"###\" ? this.setHeadLine(line.slice(3), \"h3\") : arrayOfWords[0] === \"##\" ? this.setHeadLine(line.slice(2), \"h2\") : arrayOfWords[0] === \"#\" ? this.setHeadLine(line.slice(1), \"h1\") : arrayOfWords[0].substring(0, 3) === \"---\" ? this.setInfoAboutPost(line) : arrayOfWords[0] === \"-\" ? this.setList(line.slice(1)) : arrayOfWords[0] === \">\" ? this.setBlockquote(line.slice(1)) : arrayOfWords[0].substring(0, 3) === \"```\" ? this.setCodeBlock(line) : arrayOfWords[0].substring(0, 2) === \"\\\\*\" ? this.setUnMarkableText(line) : this.setParagraph(line); //false variant\n      }\n    }\n  }, {\n    key: \"splitString\",\n    value: function splitString(stringToSplit, separator) {\n      this.arrayOfStrings = stringToSplit.split(separator);\n      return this.arrayOfStrings;\n    }\n  }, {\n    key: \"ltrim\",\n    value: function ltrim(line) {\n      if (line == null) return line;\n      return line.replace(/^\\s+/g, \"\");\n    }\n  }]);\n\n  return Line;\n}(_Word_js__WEBPACK_IMPORTED_MODULE_1__[\"Word\"]);\n\n//# sourceURL=webpack:///./src/scripts/parser/Line.js?");

/***/ }),

/***/ "./src/scripts/parser/View.js":
/*!************************************!*\
  !*** ./src/scripts/parser/View.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"View\", function() { return View; });\n/* harmony import */ var _Config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config.js */ \"./src/scripts/parser/Config.js\");\n/* harmony import */ var _Line_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Line.js */ \"./src/scripts/parser/Line.js\");\n/* harmony import */ var _Language_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Language.js */ \"./src/scripts/parser/Language.js\");\n\n\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\n\nvar View =\n/*#__PURE__*/\nfunction (_Line) {\n  _inherits(View, _Line);\n\n  function View(post) {\n    var _this;\n\n    _classCallCheck(this, View);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(View).call(this));\n    _this.Config = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    _this.post = post;\n    return _this;\n  }\n\n  _createClass(View, [{\n    key: \"render\",\n    value: function render() {\n      var _this2 = this;\n\n      var lines = this.splitString(this.post, _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].separator.newLine);\n      var article = document.querySelector(\"article\");\n      lines.forEach(function (line) {\n        if (line.length != 0) {\n          var node = _this2.parse(line);\n\n          if (node != undefined) {\n            node = _Language_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].parseLang(node);\n            article.appendChild(node);\n          }\n        }\n      });\n    }\n  }]);\n\n  return View;\n}(_Line_js__WEBPACK_IMPORTED_MODULE_1__[\"Line\"]);\n\n//# sourceURL=webpack:///./src/scripts/parser/View.js?");

/***/ }),

/***/ "./src/scripts/parser/Word.js":
/*!************************************!*\
  !*** ./src/scripts/parser/Word.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Word\", function() { return Word; });\n/* harmony import */ var _Config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Config.js */ \"./src/scripts/parser/Config.js\");\n\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar Word =\n/*#__PURE__*/\nfunction () {\n  function Word() {\n    _classCallCheck(this, Word);\n\n    this.codeBlockTrigger = false;\n    this.infoAboutPostTrigger = false;\n    this.infoAboutPost = {};\n    this.Config = _Config_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    this.datePattern = this.Config.datePattern;\n    this.titlePattern = this.Config.titlePattern;\n    this.templatePattern = this.Config.templatePattern;\n    this.thumbnailPattern = this.Config.thumbnailPattern;\n    this.slugPattern = this.Config.slugPattern;\n    this.tagsPattern = this.Config.tagsPattern;\n    this.categoriesPattern = this.Config.categoriesPattern;\n  }\n\n  _createClass(Word, [{\n    key: \"setParagraph\",\n    value: function setParagraph(line) {\n      if (line != \"\") {\n        var html = this.createElement(\"p\");\n        line = this.parseWords(line);\n        html.innerHTML = line;\n        return html;\n      }\n    }\n  }, {\n    key: \"setHeadLine\",\n    value: function setHeadLine(line, headline) {\n      var html = this.createElement(headline);\n      html.innerHTML = line;\n      return html;\n    }\n  }, {\n    key: \"setCodeBlock\",\n    value: function setCodeBlock(line) {\n      if (!this.codeBlockTrigger) {\n        //new row in the block and type of language\n        var preHTML = this.createElement(\"pre\");\n        preHTML.className = \"language-\" + line.slice(3);\n        var codeHTML = this.createElement(\"code\");\n        preHTML.appendChild(codeHTML);\n        this.codeBlockTrigger = true;\n        return preHTML;\n      } else {\n        if (line.substring(0, 3) === \"```\") {\n          //end block\n          this.codeBlockTrigger = false;\n        } else {\n          //repeat new row in the block\n          var codeblock = this.getLastNode().lastChild;\n          line = line + \"\\n\";\n          codeblock.innerHTML = codeblock.innerHTML + line;\n        }\n      }\n    }\n  }, {\n    key: \"setUnMarkableText\",\n    value: function setUnMarkableText(line) {\n      var unMarkableText = this.createElement(\"unmarkable\");\n      line = line.slice(2);\n      unMarkableText.innerHTML = \"<p>\".concat(line, \"</p>\");\n      return unMarkableText;\n    }\n  }, {\n    key: \"setInfoAboutPost\",\n    value: function setInfoAboutPost(line) {\n      if (!this.infoAboutPostTrigger) {\n        this.infoAboutPostTrigger = true;\n        this.infoAboutPost = {};\n      } else {\n        if (line.substring(0, 3) === \"---\") {\n          //end block\n          this.infoAboutPostTrigger = false;\n          var titlePost = this.infoAboutPost.title.slice(2, -1);\n          var linkPost = this.infoAboutPost.thumbnail;\n          var timePost = this.infoAboutPost.date;\n          var tagsPost = this.infoAboutPost.tags;\n          var tags = tagsPost.split(\" \");\n          tags.shift();\n          var headerPostView = \"\\n          <div class=\\\"image-wrapper\\\">\\n            <img src=\\\"\".concat(linkPost.slice(2, -1), \"\\\"/>    \\n              </div>                                \\n                <div class=\\\"flex\\\">\\n                  <h1>\").concat(titlePost, \"</h1>\\n                    <div class=\\\"post-meta\\\">\\n                      <time class=\\\"date\\\">\\n                        \").concat(timePost, \"\\n                      </time>\\n                    </div>\\n                    <div class=\\\"tag-container\\\">\\n                      \").concat(tags.map(function (tag) {\n            return \"<a href=\\\"/tags/\".concat(tag, \"\\\">\").concat(tag, \"</a>\");\n          }), \"\\n                    </div>\\n                </div>\\n                <div class=\\\"language\\\">\\n                  <a id=\\\"englishSelector\\\">En</a> |\\n                  <a id=\\\"germanSelector\\\">De</a> |\\n                  <a id=\\\"russianSelector\\\">Ru</a>\\n                </div>    \\n                \");\n          var headerPostNode = this.createElement(\"header\");\n          headerPostNode.className = \"single-header\";\n          headerPostNode.innerHTML = headerPostView;\n          return headerPostNode;\n        } else {\n          if (line.match(this.datePattern)) {\n            this.infoAboutPost.date = line.match(this.datePattern)[1];\n          }\n\n          if (line.match(this.titlePattern)) {\n            this.infoAboutPost.title = line.match(this.titlePattern)[1];\n          }\n\n          if (line.match(this.templatePattern)) {\n            this.infoAboutPost.template = line.match(this.templatePattern)[1];\n          }\n\n          if (line.match(this.thumbnailPattern)) {\n            this.infoAboutPost.thumbnail = line.match(this.thumbnailPattern)[1];\n          }\n\n          if (line.match(this.slugPattern)) {\n            this.infoAboutPost.slug = line.match(this.slugPattern)[1];\n          }\n\n          if (line.match(this.categoriesPattern)) {\n            this.infoAboutPost.categories = line.match(this.categoriesPattern)[1];\n          }\n\n          if (line.match(this.tagsPattern)) {\n            this.infoAboutPost.tags = line.match(this.tagsPattern)[1];\n          }\n        }\n      }\n    }\n  }, {\n    key: \"setBlockquote\",\n    value: function setBlockquote(line) {\n      if (this.getLastNodeName() == \"BLOCKQUOTE\") {\n        //adding to existing quote\n        var lastQuote = this.getLastNode();\n        lastQuote.innerHTML = \"<p>\".concat(lastQuote.innerHTML, \"</p> \").concat(line);\n      } else {\n        //creating new list\n        var blockquote = this.createElement(\"BLOCKQUOTE\");\n        blockquote.innerHTML = line;\n        return blockquote;\n      }\n    }\n  }, {\n    key: \"setList\",\n    value: function setList(line) {\n      line = this.parseWords(line);\n      var li_html = this.createElement(\"LI\");\n      li_html.innerHTML = line;\n\n      if (this.getLastNodeName() == \"UL\") {\n        //adding to existing list\n        var ul_html = this.getLastNode();\n        ul_html.appendChild(li_html);\n      } else {\n        //creating new list\n        var _ul_html = this.createElement(\"UL\");\n\n        _ul_html.appendChild(li_html);\n\n        return _ul_html;\n      }\n    }\n  }, {\n    key: \"parseWords\",\n    value: function parseWords(line) {\n      var _this = this;\n\n      var arrayOfWords = this.getWords(line); //for one word\n\n      var ImagesPattern = this.Config.ImagesPattern;\n      var BracketsPattern = this.Config.BracketsPattern;\n      var BracesPattern = this.Config.BracesPattern;\n      var UnderDashPattern = this.Config.UnderDashPattern;\n      var StrongPattern = this.Config.StrongPattern;\n      var CodePattern = this.Config.CodePattern;\n      var SearchLinkPattern = this.Config.SearchLinkPattern;\n      var unMarkablePattern = this.Config.UnMarkablePattern; //for several words\n\n      var StartCodePattern = this.Config.StartCodePattern;\n      var EndCodePattern = this.Config.EndCodePattern;\n      var StartStrongPattern = this.Config.StartCodePattern;\n      var EndStrongPattern = this.Config.EndStrongPattern;\n      var StartBracketsPattern = this.Config.StartBracketsPattern;\n      var EndBracketsPattern = this.Config.EndBracketsPattern;\n      var StartUnMarkablePattern = this.Config.StartUnMarkablePattern;\n      var EndUnMarkablePattern = this.Config.EndUnMarkablePattern;\n      arrayOfWords.forEach(function (value, key) {\n        //hack\n        value = _this.removeEndOfCodeWithDot(value);\n\n        if (value.match(unMarkablePattern)) {\n          arrayOfWords[key] = \"\\n                    <unmarkable>\\n                        \".concat(value.slice(2, -2), \"\\n                    </unmarkable>\\n                \");\n        } else if (value.match(StartUnMarkablePattern)) {\n          arrayOfWords[key] = \"\\n                    <unmarkable>\\n                        \".concat(value.slice(2), \"                    \\n                \");\n        } else if (value.match(EndUnMarkablePattern)) {\n          arrayOfWords[key] = \"                    \\n                        \".concat(value.slice(0, -2), \"                    \\n                        </unmarkable>\\n                \");\n        } // for links\n\n\n        if (value.match(BracketsPattern)) {\n          var nameLink = value.match(BracketsPattern)[1];\n          var link = value.match(BracesPattern)[1];\n          arrayOfWords[key] = \"<a href=\\\"\".concat(link, \"\\\">\").concat(nameLink, \"</a>\");\n        } else if (value.match(StartBracketsPattern)) {\n          var _nameLink = value.slice(1);\n\n          arrayOfWords[key] = '<a href=\"\">' + _nameLink;\n        } else if (value.match(EndBracketsPattern)) {\n          var _nameLink2 = value.match(EndBracketsPattern)[1];\n          var _link = value.match(BracesPattern)[1];\n          arrayOfWords[key] = _nameLink2 + \"</a>\";\n          arrayOfWords.forEach(function (val, i) {\n            if (val.match(SearchLinkPattern)) {\n              arrayOfWords[i] = \"<a href=\\\"\".concat(_link, \"\\\">\").concat(val.slice(11));\n            }\n          });\n        }\n\n        if (value.match(UnderDashPattern)) {\n          var _link2 = value.match(UnderDashPattern)[1];\n          arrayOfWords[key] = \"<a href=\\\"\".concat(_link2, \"\\\">\").concat(_link2, \"</a>\");\n        }\n\n        if (value.match(StrongPattern)) {\n          var text = value.match(StrongPattern)[1];\n          arrayOfWords[key] = \"<strong>\".concat(text, \"</strong>\");\n        } else if (value.match(StartStrongPattern)) {\n          var _text = value.slice(2, value.length);\n\n          arrayOfWords[key] = \"<strong>\".concat(_text);\n        } else if (value.match(EndStrongPattern)) {\n          var _text2 = value.match(EndStrongPattern)[1];\n          arrayOfWords[key] = _text2 + \"</strong>\";\n        }\n\n        if (value.match(CodePattern)) {\n          var code = value.match(CodePattern)[1];\n          arrayOfWords[key] = \"<code>\".concat(code, \"</code>\");\n        } else if (value.match(StartCodePattern)) {\n          var _code = value.match(StartCodePattern)[1];\n          arrayOfWords[key] = \"<code>\".concat(_code);\n        } else if (value.match(EndCodePattern)) {\n          var _code2 = value.match(EndCodePattern)[1];\n          arrayOfWords[key] = \"\".concat(_code2, \"</code>\");\n        }\n\n        if (value.match(ImagesPattern)) {\n          var alt = value.match(ImagesPattern)[1];\n          var src = value.match(BracesPattern)[1];\n          arrayOfWords[key] = \" <p>\\n              <a target=\\\"_blank\\\" href=\\\"\\\">\\n                <img src=\\\"\\n                  \".concat(src, \"\\\" alt=\\\"\\n                  \").concat(alt, \"\\\">\\n                </img>\\n            </p>\");\n        }\n      }); //console.log(arrayOfWords.join(' '))\n\n      return arrayOfWords.join(\" \");\n    }\n  }, {\n    key: \"getWords\",\n    value: function getWords(line) {\n      return line.split(this.Config.separator.newSpace);\n    }\n  }, {\n    key: \"getLastNode\",\n    value: function getLastNode() {\n      var lastChild = this.getRoot();\n      return lastChild.lastChild;\n    }\n  }, {\n    key: \"getLastNodeName\",\n    value: function getLastNodeName() {\n      var lastChild = this.getRoot();\n      return lastChild.lastChild.nodeName;\n    }\n  }, {\n    key: \"getRoot\",\n    value: function getRoot() {\n      return document.querySelector(\"article\");\n    }\n  }, {\n    key: \"createElement\",\n    value: function createElement(element) {\n      return document.createElement(element);\n    } //some problems when use `example`. in the markable text\n\n  }, {\n    key: \"removeEndOfCodeWithDot\",\n    value: function removeEndOfCodeWithDot(value) {\n      if (value.slice(-1) === \".\" && value.slice(-2, -1) === \"`\") {\n        return value.slice(0, -1);\n      } else if (value.slice(-1) === \".\" && value.slice(-3, -1) === \"**\") {\n        return value.slice(0, -1);\n      } else {\n        return value;\n      }\n    }\n  }]);\n\n  return Word;\n}();\n\n//# sourceURL=webpack:///./src/scripts/parser/Word.js?");
...
/***/ 0:
/*!*************************************************************************!*\
  !*** multi babel-polyfill ./src/scripts/index.js ./src/scss/style.scss ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\n__webpack_require__(/*! ./src/scripts/index.js */\"./src/scripts/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/scss/style.scss */\"./src/scss/style.scss\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/scripts/index.js_./src/scss/style.scss?");
